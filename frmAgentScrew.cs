    ...
    public partial class frmAgentScrew : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmAgentScrew()
        {
           // client = new MqttClient(IPAddress.Parse(ServerIp));
            ...
            HevAgent.DeleteValue("HEV_FI_Agent", false);
            HevAgent.SetValue("HEV_FI_Agent", Application.ExecutablePath);
        ...
        private void PhanTichImei(string filep, string fname)
        {
            ...
            try
            {
                ...
                string[] ketqua2 = ketqua1[2].Split(']');
                string Code = "";

                if (ketqua2[0].Length > 8)
                    Code = ketqua2[0].Substring(0, ketqua2[0].Length - 3);
                else
                    Code = ketqua2[0];
